...
related:
  ...
  prs: []
  issues:
    - "https://github.com/bravellian/workbench/issues/142"
  branches: []
title: define release packaging and distribution
---

# TASK-0250 - define release packaging and distribution

## Summary

Imported from GitHub issue: https://github.com/bravellian/workbench/issues/142
