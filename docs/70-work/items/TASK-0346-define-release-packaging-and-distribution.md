...
related:
  ...
  prs: []
  issues:
    - "https://github.com/bravellian/workbench/issues/39"
  branches: []
title: define release packaging and distribution
---

# TASK-0346 - define release packaging and distribution

## Summary

Imported from GitHub issue: https://github.com/bravellian/workbench/issues/39
